...
//=============== Define markets and channels...
    ...
    public static Business initializeRandom(){
        Business business = new Business("Xerox");
        business.displayBusinessInfo();
        DataLoader.setBusiness(business);
        DataLoader.loadData();
        business.displayBusinessInfo();
        SolutionHelper sh = new SolutionHelper(business);
        SalesAnalyticsReport sar = new SalesAnalyticsReport(business);
        sar.generateReport();
        // Create Persons
        PersonDirectory persondirectory = business.getPersonDirectory();
        // person representing sales organization        
