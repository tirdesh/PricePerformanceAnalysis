...
//        MarketChannelAssignment mca2 = marketChannelComboCatalog.newMarketChannelCombo(market, c);
    ...
    public void displayBusinessInfo() {
        ...
        System.out.println("Number of Customers: " + customerdirectory.getCustomerList().size());
        System.out.println("Number of Salespersons: " + salespersondirectory.getSalesPersonList().size());
        System.out.println("Number of Suppliers: " + suppliers.getSupplierList().size());
